...
def main():
    ...
    for seed, current_epoch in zip(aa, best_epoch):
        ...
        dataFolder = './1-in-domain/1-random-splits/Bacteria/data' # random-splits;cold-peptides;cold-bacteria data
